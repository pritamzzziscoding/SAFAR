...
export const SignUp = () =>{
    return <div className="signup-page grid md:grid-cols-2">
        <div className="flex flex-col justify-evenly z-10 h-[90%] md:h-[60%] w-[90%] border-4 border-blue-50/50 bg-blue-50/60 rounded-2xl shadow-2xl place-self-center">
        ...
        <div className="flex flex-col justify-evenly z-10 h-[90%] md:h-[60%] w-[90%] border-4 border-blue-50/50 bg-blue-50/55 rounded-2xl shadow-2xl place-self-center">
