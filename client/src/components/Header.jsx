...
export const Header = () => {
  ...
  const handleImageClick = () => {
    ...
    return (
        <header className="z-50 header bg-gradient-to-r from-stone-200 via-stone-50 to-stone-200 home-header w-full flex justify-between items-center h-15 shadow-2xl fixed top-0 left-0">
