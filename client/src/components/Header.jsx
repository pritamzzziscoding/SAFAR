...
export const Header = () => {
  ...
  const handleImageClick = () => {
    ...
    return (
        <header className="z-30 header bg-gradient-to-r from-stone-200 via-stone-50 to-stone-200 home-header w-full flex justify-between items-center h-15 shadow-2xl fixed top-0 left-0">
            ...
            <span className="flex items-center gap-5">
                ...
                <img onClick={handleImageClick} className="cursor-pointer h-10 w-10 bg-amber-300 rounded-full border-amber-500 border-2" src={detail.image_url || "https://i.imgflip.com/6yvpkj.jpg"} alt="." />
            </span>
